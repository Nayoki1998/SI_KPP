...
-->
		...
		<!-- Fonts-->
		<link rel="stylesheet" type="text/css" href="{{ asset('comingsoon/assets/fonts/fontawesome/font-awesome.min.css') }}">
		<!-- Vendors-->
		<link rel="stylesheet" type="text/css" href="{{ asset('comingsoon/assets/vendors/bootstrap/grid.css') }}">
		<link rel="stylesheet" type="text/css" href="{{ asset('comingsoon/assets/vendors/YTPlayer/css/jquery.mb.YTPlayer.min.css') }}">
		<link rel="stylesheet" type="text/css" href="{{ asset('comingsoon/assets/vendors/vegas/vegas.min.css') }}">
		<!-- App & fonts-->
		...
		<link rel="stylesheet" type="text/css" id="app-stylesheet" href="{{ asset('comingsoon/assets/css/main.css') }}"><!--[if lt IE 9]>
	...
	<body>
		<div class="page-wrap" id="root">
			...
			<div class="md-content">
				...
				<div class="hero md-skin-dark" style="
        /* background-size: contain; */
        /* transform: rotate(45deg); */
        background-image :url(https://i.pinimg.com/originals/91/fb/2c/91fb2c0c6fed103700cb5b37094be939.jpg);">
					...
					<div class="container">
						<div class="hero__wrapper">
							...
							<div class="countdown__module hide" data-date="2024/3/21">
		...
		<!-- Vendors-->
		<script type="text/javascript" src="{{ asset('comingsoon/assets/vendors/jquery/jquery.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('comingsoon/assets/vendors/jquery.countdown/jquery.countdown.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('comingsoon/assets/vendors/flat-surface-shader/fss.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('comingsoon/assets/vendors/particles.js/particles.js') }}"></script>
		<script type="text/javascript" src="{{ asset('comingsoon/assets/vendors/waterpipe/waterpipe.js') }}"></script>
		<script type="text/javascript" src="{{ asset('comingsoon/assets/vendors/quietflow/quietflow.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('comingsoon/assets/vendors/YTPlayer/jquery.mb.YTPlayer.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('comingsoon/assets/vendors/vegas/vegas.min.js') }}"></script>

   
		<!-- App-->
		<script type="text/javascript" src="{{ asset('comingsoon/assets/js/main.js') }}"></script>
	</body>
</html>