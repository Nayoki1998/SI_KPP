			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
						<h6 class="mb-0 text-uppercase">Form Penelitian</h6>
						<hr/>
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="card-title d-flex align-items-center">
										...
										<h5 class="mb-0 text-info">Berkas Penelitian</h5>
									</div>
									<hr/>
                  <form action="{{ route('pen.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="{{ old('perihal') }}" name="perihal" class="form-control @error('perihal') is-invalid @enderror" id="inputEnterYourName" placeholder="Perihal Penelitian">
                      </div>
                    </div>
                    @error('perihal')
