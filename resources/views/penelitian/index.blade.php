    ...
    <div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Penelitian</div>
					<div class="ps-3">
				...
				<div style="display: flex; justify-content: space-between">
					<h6 class="mb-0 text-uppercase">Datatable Penelitian</h6>
					<a href="{{ route('pen.create') }}" class="btn btn-success px-2" style="justify-content: space-between ">
								...
								<tbody>
									...
									@forelse ($data as $item)
										<tr>
											...
											<td>{{ $item->perihal }}</td>
											<td>
												<a type="button" href="{{ asset('penelitian/'.$item->berkas) }}" class="btn btn-info px-5" download="penelitian">
											...
											<td>
												<form action="{{ route('pen.destroy', $item->id) }}" method="post">
													@csrf
													@method('delete')
													<a id="berkasId" href="{{ route('pen.edit', $item->id) }}" class="btn btn-warning">
