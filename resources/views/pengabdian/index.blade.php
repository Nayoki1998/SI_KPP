    ...
    <div class="page-wrapper">
			<div class="page-content">
				...
				<div style="display: flex; justify-content: space-between">
					<h6 class="mb-0 text-uppercase">Datatable Pengabdian</h6>
					<a href="{{ route('peng.create') }}" class="btn btn-success px-2" style="justify-content: space-between ">
								...
								<tbody>
									...
									@forelse ($data as $item)
										<tr>
											...
											<td>{{ $item->perihal }}</td>
											<td>
												<a type="button" href="{{ asset('pengabdian/'.$item->berkas) }}" class="btn btn-info px-5" download="berkas_pengabdian">
											...
											<td>
												<form action="{{ route('peng.destroy', $item->id) }}" method="post">
													@csrf
													@method('delete')
													<a id="berkasId" href="{{ route('peng.edit', $item->id) }}" class="btn btn-warning">
